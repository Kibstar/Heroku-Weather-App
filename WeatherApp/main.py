...
class General:
    ...
    def __init__(self,city_name): # Takes in Lat and Long and then finds the data on the internet with an API call.
        self.max_wind = 17
        self.min_temp = 10
        self.city_name = city_name
        self.lat = lat
        self.long = long
        self.get_weather_data_city() # Weather data for each instance are stored in a parent class where a few other variables are stored.
        self.unique_dates()
        self.times()
        self.data()
    ...
    def get_weather_data_city(self): # Gathers the data from the internet using, Lat, Long and API key.
